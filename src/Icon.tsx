...
const paths: Record<Exclude<IconName, "logo">, string[]> = {
  alert: [
    "M12 9v4",
    "M12 17h.01",
    "M10.3 3.9 2.5 17.5A2 2 0 0 0 4.2 20h15.6a2 2 0 0 0 1.7-2.5L13.7 3.9a2 2 0 0 0-3.4 0Z",
  ],
  arrow: ["m9 18 6-6-6-6"],
  ...
  folderOpen: [
    ...
    "M3 17.5 5.2 11h17.3l-2.2 6.5A2 2 0 0 1 18.4 19H4.9A2 2 0 0 1 3 17.5Z",
  ],
  history: ["M3 12a9 9 0 1 0 3-6.7L3 8", "M3 3v5h5", "M12 7v5l3 2"],
  panel: ["M4 4h16v16H4z", "M9 4v16"],
  pin: ["M12 17v5", "M5 3h14", "M7 3l1.5 7L5 14h14l-3.5-4L17 3"],
  ...
  spark: [
    "m12 3-1.1 3.3A4 4 0 0 1 8.3 9L5 10l3.3 1.1a4 4 0 0 1 2.6 2.6L12 17l1.1-3.3a4 4 0 0 1 2.6-2.6L19 10l-3.3-1.1a4 4 0 0 1-2.6-2.6Z",
    "m5 3 .5 1.5L7 5l-1.5.5L5 7l-.5-1.5L3 5l1.5-.5Z",
    "m19 17 .5 1.5L21 19l-1.5.5L19 21l-.5-1.5L17 19l1.5-.5Z",
  ],
  ...
  if (name === "logo") {
    return (
      <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true" {...props}>
        ...
        <path
          d="m9.5 17.5 2.5 1.4 5.6-3.2V9.3"
          fill="none"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
