...
export const UI_TEXT = {
  ru: {
    ...
    transcriptPreviousMatch: "Предыдущее совпадение",
    transcriptNextMatch: "Следующее совпадение",
    transcriptMatchCount: "Совпадения",
    operationsTab: "Работа OMP",
    operationsHelp:
      "Глобальные параметры установленного OMP. Изменяются только отредактированные поля; проектные настройки сохраняют приоритет. Новые значения гарантированно применяются в новых OMP-сессиях, текущие сессии не перезапускаются.",
    operationsSearch: "Поиск по ключу или описанию",
    operationsAll: "Все категории",
    operationsAgent: "Поведение агента",
    operationsContext: "Контекст и сжатие",
    operationsRetry: "Повторы и ожидание",
    operationsTools: "Инструменты и выполнение",
    operationsTerminal: "Терминал и вывод",
    operationsTasks: "Сессии, задачи и память",
    operationsModified: "Только изменённые",
    operationsEmpty: "Нет подходящих параметров",
    operationsUnavailable:
      "Каталог параметров недоступен. Обновите настройки или проверьте подключение OMP.",
    operationsEffective: "Эффективное значение",
    operationsUnset: "Не задано",
    operationsReset: "По умолчанию OMP",
    operationsResetHelp:
      "Записывает значение по умолчанию из схемы OMP, а не удаляет переопределение. Будет применено при сохранении.",
    operationsResetPending: "Будет записано значение по умолчанию OMP",
    operationsUndo: "Отменить изменение",
    operationsInvalidNumber: "Введите конечное число для {key}",
    operationsOn: "Включено",
    operationsOff: "Выключено",
    ...
    resourceWarning: "Требуется внимание к ресурсам",
    resourceCritical: "Критически мало ресурсов",
    resourceUnavailable: "Показатели ресурсов недоступны",
    resourcePartial:
      "Измерение неполное: некоторые пути недоступны. Проверьте доступ к указанным ниже путям; показатели остальных ресурсов сохранены.",
    ...
    transcriptRead: "Читать",
    transcriptReadHint:
      "Открыть сохранённый диалог с Markdown и копированием; терминал продолжит работать",
    transcriptLatest: "К последнему сообщению",
    transcriptAppearance: "Отображение сообщений",
    transcriptRendered: "Оформление",
    transcriptSource: "Исходник",
    transcriptCodeText: "Текст",
    copyCode: "Копировать блок",
    copyMessage: "Копировать текст",
    copyMarkdown: "Копировать Markdown",
    copying: "Копируем…",
    clipboardCopied: "Скопировано",
    completedAnswer: "Готовый ответ",
    completedAnswerPrevious: "Предыдущий ответ",
    completedAnswerNext: "Следующий ответ",
    completedAnswerHide: "Свернуть ответ",
    completedAnswerShow: "Показать ответ",
    ...
    incidentCaptureSave: "Сохранить сырой вывод",
    incidentCaptureSaving: "Сохранение…",
    incidentCaptureSaved: "Сохранено {size}: {path}",
  ...
  en: {
    ...
    transcriptPreviousMatch: "Previous match",
    transcriptNextMatch: "Next match",
    transcriptMatchCount: "Matches",
    operationsTab: "OMP operation",
    operationsHelp:
      "Global settings of the installed OMP. Only edited fields are written; project settings keep precedence. New values are guaranteed for new OMP sessions; running sessions are not restarted.",
    operationsSearch: "Search keys or descriptions",
    operationsAll: "All categories",
    operationsAgent: "Agent behavior",
    operationsContext: "Context and compaction",
    operationsRetry: "Retry and waiting",
    operationsTools: "Tools and execution",
    operationsTerminal: "Terminal and output",
    operationsTasks: "Sessions, tasks and memory",
    operationsModified: "Changed only",
    operationsEmpty: "No matching settings",
    operationsUnavailable:
      "Settings catalog unavailable. Refresh settings or check the OMP connection.",
    operationsEffective: "Effective value",
    operationsUnset: "Not set",
    operationsReset: "OMP default",
    operationsResetHelp:
      "Writes the OMP schema default, rather than removing an override. Applied on save.",
    operationsResetPending: "OMP default will be written",
    operationsUndo: "Undo change",
    operationsInvalidNumber: "Enter a finite number for {key}",
    operationsOn: "On",
    operationsOff: "Off",
    ...
    resourceWarning: "Resources need attention",
    resourceCritical: "Resources are critically low",
    resourceUnavailable: "Resource metrics are unavailable",
    resourcePartial:
      "Measurement is incomplete: some paths are unavailable. Check access to the paths listed below; other resource metrics are still shown.",
    ...
    transcriptRead: "Read",
    transcriptReadHint:
      "Read the saved dialogue with Markdown and copy actions; the terminal keeps running",
    transcriptLatest: "Latest message",
    transcriptAppearance: "Message display",
    transcriptRendered: "Formatted",
    transcriptSource: "Source",
    transcriptCodeText: "Text",
    copyCode: "Copy block",
    ...
    completedAnswerPrevious: "Previous answer",
    completedAnswerNext: "Next answer",
    completedAnswerHide: "Collapse answer",
    completedAnswerShow: "Show answer",
    ...
    incidentCaptureSave: "Save raw output",
    incidentCaptureSaving: "Saving…",
    incidentCaptureSaved: "Saved {size}: {path}",
